...
namespace recipe_7_04 {
  ...
  void print1()
  {
    ...
    std::vector<Company> companies{
      ...
      { "China National Petroleum"s, "Oil and gas"s, 299, false, 30.21, 1589508,
        "China"s },
    ...
    for (auto const& company : companies) {
      ...
      std::cout << std::left << std::setw(5) << std::setfill(' ') << std::boolalpha
                << company.RevenueIncrease;
      std::cout << std::right << std::setw(5) << std::setfill(' ') << std::fixed
                << std::setprecision(1) << company.Growth << std::defaultfloat
                << std::setprecision(6) << ' ';
  ...
  void print_toc(Book const& book)
  {
    ...
    for (auto const& part : book.Parts) {
      std::cout << std::left << std::setw(15) << std::setfill(' ') << part.Title
                << std::endl;
      std::cout << std::left << std::setw(15) << std::setfill('-') << '-' << std::endl;
  ...
  void execute()
  {
    ...
    {
      std::cout << std::fixed << 0.25 << std::endl;        // 0.250000
      std::cout << std::scientific << 0.25 << std::endl;   // 2.500000e-01
      std::cout << std::hexfloat << 0.25 << std::endl;     // 0x1p-2
      std::cout << std::defaultfloat << 0.25 << std::endl; // 0.25
    }
