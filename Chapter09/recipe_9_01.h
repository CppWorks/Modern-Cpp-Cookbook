...
class simple_error : public std::exception {
 public:
  virtual const char *what() const noexcept override { return "simple exception"; }
};

class another_logic_error : public std::logic_error {
 public:
  another_logic_error() : std::logic_error("simple logic exception") {}
};
...
void another_throwing_func() { throw std::string{"error!"}; }

void throw_simple() { throw simple_error(); }

void throw_advanced() { throw advanced_error(42); }
