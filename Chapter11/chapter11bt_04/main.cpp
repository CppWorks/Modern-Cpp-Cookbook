...
struct extended_fixture {
  ...
  ~extended_fixture() { BOOST_TEST_MESSAGE("cleanup " + name); }
};

void fixture_setup() { BOOST_TEST_MESSAGE("fixture setup"); }

void fixture_cleanup() { BOOST_TEST_MESSAGE("fixture cleanup"); }
...
BOOST_AUTO_TEST_CASE(case1) { BOOST_TEST(data == 0); }
...
BOOST_FIXTURE_TEST_CASE(case2, standard_fixture) { BOOST_TEST(n == 42); }
