...
void execute() {
...

  {
    ...
    // When you want to iterate over a range, you don't care about the actual type of the
    // iterator.
  ...
  {
    foo f(42);
    //  If you need a const/volatile and/or reference type, then you need to specify them
    //  explicitly. If you need a const/volatile and/or reference type, then you need to
  ...
  {
    //  As of C++14, both lambda return type and lambda parameter types can be auto. Such
    //  a lambda is called a *generic lambda* because the closure type defined by the lambda
