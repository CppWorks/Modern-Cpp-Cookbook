...
namespace recipe_1_02 {
  ...
  // Typedef declarations cannot be used with templates to create template type aliases.
  // An std::vector<T>, for instance, is not a type (std::vector<int> is a type), but a
  // sort of family of all types that can be created when the type placeholder T is
  // replaced with an actual type.
