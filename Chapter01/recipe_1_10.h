...
struct foo2 {
  foo2() { std::cout << "foo" << std::endl; }
  foo2(std::initializer_list<int> l) { std::cout << "foo(l)" << std::endl; }
  foo2(int const a) { std::cout << "foo(a)" << std::endl; }
  foo2(int const a, double const b) { std::cout << "foo(a, b)" << std::endl; }
