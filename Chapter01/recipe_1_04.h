...
void execute() {
...

  {
    ...
    // constructor initializer list, the latter takes precedence and the default value is
    // discarded.
    struct bar {
      foo f{"default value"};
    ...
    // Using the appropriate initialization method for each member leads not only to more
    // efficient code but also to better organized and more readable code.
    bar b;
  }
}
}  // namespace recipe_1_04
