...
class base {
 public:
  void func1() { static_cast<T*>(this)->func1(); }
};
...
class button : public control<button> {
 private:
  ...
  void erase_background() { std::cout << "erasing button background..." << std::endl; }
...
class checkbox : public control<checkbox> {
 public:
  void erase_background() { std::cout << "erasing checkbox background..." << std::endl; }
...
class fancybutton : public control<fancybutton<T>> {
 public:
  void erase_background() { static_cast<T*>(this)->paint_area(); }
